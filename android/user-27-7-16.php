...
{	
	...
	$response = array("act" => "login", "schoolid" => $_REQUEST['schoolid'], "success" => 0, "success_msg" => "", "error" => 0, "error_msg" => "");
	if(empty($params['studentid']))
	{
		$response["error"] = 1;
		$response["error_msg"] = "Username is blank.";
//		echo "Username or Password is Blank";
	...
	else
	{
		...
		if(count($row)>0)
		{
			...
			$data['stdCurrentStandard']=ucwords($stnName[0]['stnName']);
			
			$clsName=$db->Direct_Query("select clsName from ".DB_PREFIX."class where clsId='".$row[0]['stdCurrentClass']."'");
			$data['stdCurrentClass']=ucwords($clsName[0]['clsName']);
...
{	
	global $db,$cmn,$imagePath,$SITEURL,$android;
	$response = array("act" => "resetpassword", "schoolid" => $_REQUEST['schoolid'], "success" => 0, "success_msg" => "", "error" => 0, "error_msg" => "","data"=>"");
	 
	$column=array('stdPass'=>$cmn->Set_Value($params['newpass']));
...
{
	global $db,$cmn,$imagePath,$SITEURL,$android;
	$response = array("act" => "forgotpassword", "schoolid" => $_REQUEST['schoolid'], "success" => 0, "success_msg" => "", "error" => 0, "error_msg" => "","data"=>"");
...
{
	global $db,$cmn,$imagePath,$SITEURL,$android;
	$response = array("act" => "cmspage", "schoolid" => $_REQUEST['schoolid'], "success" => 0, "success_msg" => "", "error" => 0, "error_msg" => "","data"=>"");
...
function photogalary($params=array())
{
	...
	$response = array("act" => "photogalary", "schoolid" => $_REQUEST['schoolid'], "success" => 0, "success_msg" => "", "error" => 0, "error_msg" => "","data"=>"");
...
{
	global $db,$cmn,$imagePath,$android;
	$response = array("act" => "getTestDetails", "schoolid" => $_REQUEST['schoolid'], "success" => 0, "success_msg" => "", "error" => 0, "error_msg" => "","data"=>"");
	...
	{	
		...
		foreach($row as $_row)
		{
			$data[$i]["subject"]=$cmn->Get_One_Name("subject","subName","subId='".$cmn->Get_Value($_row['sesSubjectId'])."'");
			$data[$i]["examDate"]=$cmn->Convert_Date_To_Ddmmyyyy($_row['sesExamDate']);
			$data[$i]["chapterName"]=$cmn->Get_Value($_row['sesChapterName']);
...
{
	global $db,$cmn,$imagePath,$android;
	$response = array("act" => "getHomework", "schoolid" => $_REQUEST['schoolid'], "success" => 0, "success_msg" => "", "error" => 0, "error_msg" => "","data"=>"");
	...
	{	
		...
		foreach($row as $_row)
		{
			...
			{
				$data[$i]["swkSubjectId"]=$cmn->Get_One_Name("subject","subName","subId=".$cmn->Get_Value($_row['swkSubjectId']));
			}
...
{
	global $db,$cmn,$imagePath,$android;
	$response = array("act" => "getAttendance", "schoolid" => $_REQUEST['schoolid'], "success" => 0, "success_msg" => "", "error" => 0, "error_msg" => "","data"=>"");
...
{
	global $db,$cmn,$imagePath,$android;
	$response = array("act" => "insertfeedback", "schoolid" => $_REQUEST['schoolid'], "success" => 0, "success_msg" => "", "error" => 0, "error_msg" => "","data"=>"");
		...
		{	
			$cmn->Send_Email("application",$params['comment']);
...
{
	global $db,$cmn,$imagePath,$android;
	$response = array("act" => "getLectureAndExamTimeTable", "schoolid" => $_REQUEST['schoolid'], "success" => 0, "success_msg" => "", "error" => 0, "error_msg" => "","data"=>"");
...
/*function getNotificationHomework($params=array())
{
	...
	{	
		...
		foreach($row as $_row)
		{
			$data[$i]["notiSubject"]=$cmn->Get_Value($_row['notiSubject']);
...
function getNotificationAttendance($params=array())
{
	global $db,$cmn,$imagePath,$android;
	$response = array("act" => "getNotificationAttendance", "schoolid" => $_REQUEST['schoolid'], "success" => 0, "success_msg" => "", "error" => 0, "error_msg" => "","data"=>"");
	...
	{	
		...
		foreach($row as $_row)
		{
			$data[$i]["notiSubject"]=$cmn->Get_Value($_row['notiSubject']);
			$data[$i]["notiDesc"]=$cmn->Get_Value($_row['notiDesc']);
			$data[$i]["notiPresentAbsent"]=$cmn->Get_Value($_row['notiPresentAbsent']);
			$data[$i]["notiDate"]=$cmn->Convert_Date_To_Ddmmyyyy($_row['notiDate']);
			$i++;
		}
...
{
	global $db,$cmn,$imagePath,$android;
	$response = array("act" => "getNotificationStudent", "schoolid" => $_REQUEST['schoolid'], "success" => 0, "success_msg" => "", "error" => 0, "error_msg" => "","data"=>"");
	...
	$notirow=$db->Direct_Query($notisql);
		...
		{	
			...
			$dataInner[$i]["notiType"]=ucwords($cmn->Get_Value($_notirow['notiType']));
			$dataInner[$i]["notiSubject"]=ucwords($cmn->Get_Value($_notirow['notiSubject']));
			
			if($_row['notiType']=="attendance")
			{
				$dataInner[$i]["notiDesc"]=$cmn->Get_Value($_notirow['notiDesc'])." ".$cmn->Get_Value($_notirow['notiPresentAbsent']);
			}
			else
			{
...
{
	global $db,$cmn,$imagePath,$android;
	$response = array("act" => "getNotificationCommon", "schoolid" => $_REQUEST['schoolid'], "success" => 0, "success_msg" => "", "error" => 0, "error_msg" => "","data"=>"");
	...
	{	
		...
		foreach($row as $_row)
		{
			...
			$data[$i]["notiType"]=ucwords($cmn->Get_Value($_row['notiType']));
			$data[$i]["notiSubject"]=ucwords($cmn->Get_Value($_row['notiSubject']));
			$data[$i]["notiDesc"]=$cmn->Get_Value($_row['notiDesc']);
			$data[$i]["notiDate"]=$cmn->Convert_Date_To_Ddmmyyyy($_row['notiDate']);
			$i++;
		 }
...
{
	global $db,$cmn,$imagePath,$android;
	$response = array("act" => "setNotificationToRead", "schoolid" => $_REQUEST['schoolid'], "success" => 0, "success_msg" => "", "error" => 0, "error_msg" => "","data"=>"");
	...
	$stsql="select notiId,notiStudentId from ".DB_PREFIX."notification where notiId in (".$notiId.")";
		...
		{	
			...
			{ 	
				...
				$column=array('notiStudentId'=>$cmn->Set_Value($pendingStudId));
...
{	
	global $db,$cmn,$imagePath,$SITEURL,$android;
	$response = array("act" => "updatefcm", "schoolid" => $_REQUEST['schoolid'], "success" => 0, "success_msg" => "", "error" => 0, "error_msg" => "","data"=>"");
	 
	$column=array('stdFcmId'=>$cmn->Set_Value($_REQUEST['stdFcmId']));
